...
# stolen from https://github.com/nodejs/docker-node/blob/main/12/alpine3.12/Dockerfile
...
RUN apk add --no-cache bash build-base cmake git openssl-dev postgresql-dev shared-mime-info tzdata
